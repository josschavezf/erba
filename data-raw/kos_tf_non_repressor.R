...
kos_tf_non_repressor <- read.delim("kos_transcription_factor_non_repressor", header = FALSE)
kos_tf_non_repressor <- as.character(kos_tf_non_repressor[[1]])

# save data into the package
usethis::use_data_raw(name = "kos_tf_non_repressor")
